...
define(['lazy-load/lazyLoad'],
    ...
    function (lazyLoadModule) {
        ...
        var configArr = [{
            ...
            scripts: {
                controllers: ['business/backend/controllers/backendCtrl']
            }
        }, {
            name: 'admin',
            url: '/admin',
            templateUrl: 'business/backend/views/admin.html',
            controller: 'adminCtrl',
            scripts: {
                controllers: [
                    'business/backend/controllers/adminCtrl',
                    'business/backend/controllers/addCtrl'
                ]
            }
        }];
